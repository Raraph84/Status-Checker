            ...
            if (net.isIPv4(host)) {
                if (service.protocol === 6)
                    newServices.push({
                        ...
                        ipv6: null,
                        ip: null,
                        error: new Error("IPv4 address provided for IPv6 protocol")
                    });
                else newServices.push({ ...service, ipv4: host, ipv6: null, ip: host, error: null });
                ...
                if (service.protocol === 4)
                    newServices.push({
                        ...
                        ipv6: null,
                        ip: null,
                        error: new Error("IPv6 address provided for IPv4 protocol")
                    });
                else newServices.push({ ...service, ipv4: null, ipv6: host, ip: host, error: null });
            } else {
                if (service.type === "minecraft") {
                    ...
                    if (results && results[0]) host = results[0].name;
                }
                ...
                await dns
                    ...
                    .then((res) => (ipv6 = res.address))
                    .catch((e) => (ipv6error = e));
                await dns
                    .lookup(host, { family: 4 })
                    .then((res) => (ipv4 = res.address))
                    .catch((e) => (ipv4error = e));
                ...
                if (service.protocol === 4) {
                    ...
                    if (ipv6 || ipv4) newServices.push({ ...service, ipv4, ipv6, ip: ipv6 ?? ipv4, error: null });
                        ...
                        newServices.push({
                            ...
                            ipv6: null,
                            ip: null,
                            error: new AggregateError([ipv6error, ipv4error])
                        });
                }
            }
        }
