    ...
    for (const ping of pings) {
        ...
        try {
            await database.query(
                ...
                [ping.service_id, ping.checker_id, ping.start_time, ping.duration, ping.sent, ping.lost, ping.med_response_time, ping.min_response_time, ping.max_response_time, ping.downs]
            );
        } catch (error) {
